...
import { Tabs, TabItem, Steps, Aside } from "@/components/mdx";
...
<TabItem label="Postman">
  ![creating list](../../assets/articles/haunting-empty-assets--finding-empty-assets.png)
...
2.  Fire the Proton Pack (Bulk Delete)
    ...
    ```
          ...
          <TabItem label="Postman">
          ![creating list](../../assets/articles/haunting-empty-assets--deleting-empty-assets.png)
