...
1. Collect the Ghost UIDs (Empty Assets)
    ...
    Run the command above again, but this time, you'll want to gather all the uid values from the response. You can increase the limit parameter to get more results at once.
